...
outpref=distances_prop_positive_${prop_positive}_HGT_rate_${HGT_rate}_rate_genes1_${rate_genes1}_prop_genes2_${prop_genes2}_baseline
...
outpref=distances_prop_positive_${prop_positive}_HGT_rate_${HGT_rate}_rate_genes1_${rate_genes1}_prop_genes2_${prop_genes2}
./pansim/target/release/pansim --n_gen ${ngen} --pop_size ${npop} --core_size ${core_nuc} --pan_genes ${pan} --core_genes ${core} --avg_gene_freq ${freq} --threads 4 --core_mu ${mu_core} --HR_rate ${HR_rate} --HGT_rate ${HGT_rate} --rate_genes1 ${rate_genes1} --rate_genes2 ${rate_genes2} --prop_genes2 ${prop_genes2} --prop_positive ${prop_positive} --pos_lambda ${pos_lambda} --neg_lambda ${neg_lambda} --outpref ${outpref} --verbose
...
outpref=distances_prop_positive_${prop_positive}_HGT_rate_${HGT_rate}_rate_genes1_${rate_genes1}_prop_genes2_${prop_genes2}_strong_competition
