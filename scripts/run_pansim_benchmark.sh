...
core=1342
pan=4400
# based on average genome size 2000 genes
freq=0.45 
ngen=100
npop=1000
mu_core=0.019
...
# changing params - very weak competition
echo "no competition"
prop_positive=-0.1
HGT_rate=0.0
rate_genes1=1.0
...
outpref=prop_positive_${prop_positive}_HR_rate_${HR_rate}_HGT_rate_${HGT_rate}_rate_genes1_${rate_genes1}_prop_genes2_${prop_genes2}_competition_0.0
./pansim/target/release/pansim --n_gen ${ngen} --pop_size ${npop} --core_size ${core_nuc} --pan_genes ${pan} --core_genes ${core} --avg_gene_freq ${freq} --threads 4 --core_mu ${mu_core} --HR_rate ${HR_rate} --HGT_rate ${HGT_rate} --rate_genes1 ${rate_genes1} --rate_genes2 ${rate_genes2} --prop_genes2 ${prop_genes2} --prop_positive ${prop_positive} --pos_lambda ${pos_lambda} --neg_lambda ${neg_lambda} --outpref ${outpref} --verbose --competition_strength 0.0


# changing params - weak competition
echo "weak competition"
prop_positive=-0.1
HGT_rate=0.0
rate_genes1=1.0
prop_genes2=0.0
...
outpref=prop_positive_${prop_positive}_HR_rate_${HR_rate}_HGT_rate_${HGT_rate}_rate_genes1_${rate_genes1}_prop_genes2_${prop_genes2}_competition_100
./pansim/target/release/pansim --n_gen ${ngen} --pop_size ${npop} --core_size ${core_nuc} --pan_genes ${pan} --core_genes ${core} --avg_gene_freq ${freq} --threads 4 --core_mu ${mu_core} --HR_rate ${HR_rate} --HGT_rate ${HGT_rate} --rate_genes1 ${rate_genes1} --rate_genes2 ${rate_genes2} --prop_genes2 ${prop_genes2} --prop_positive ${prop_positive} --pos_lambda ${pos_lambda} --neg_lambda ${neg_lambda} --outpref ${outpref} --verbose --competition_strength 100

# changing params - strong competition
echo "strong competition"
prop_positive=-0.1
HGT_rate=0.0
rate_genes1=1.0
prop_genes2=0.0
...
./pansim/target/release/pansim --n_gen ${ngen} --pop_size ${npop} --core_size ${core_nuc} --pan_genes ${pan} --core_genes ${core} --avg_gene_freq ${freq} --threads 4 --core_mu ${mu_core} --HR_rate ${HR_rate} --HGT_rate ${HGT_rate} --rate_genes1 ${rate_genes1} --rate_genes2 ${rate_genes2} --prop_genes2 ${prop_genes2} --prop_positive ${prop_positive} --pos_lambda ${pos_lambda} --neg_lambda ${neg_lambda} --outpref ${outpref} --verbose  --competition_strength 10000

# changing params - very very strong competition
echo "very very competition"
prop_positive=-0.1
HGT_rate=0.0
rate_genes1=1.0
prop_genes2=0.0
...
./pansim/target/release/pansim --n_gen ${ngen} --pop_size ${npop} --core_size ${core_nuc} --pan_genes ${pan} --core_genes ${core} --avg_gene_freq ${freq} --threads 4 --core_mu ${mu_core} --HR_rate ${HR_rate} --HGT_rate ${HGT_rate} --rate_genes1 ${rate_genes1} --rate_genes2 ${rate_genes2} --prop_genes2 ${prop_genes2} --prop_positive ${prop_positive} --pos_lambda ${pos_lambda} --neg_lambda ${neg_lambda} --outpref ${outpref} --verbose --competition_strength 100000000
